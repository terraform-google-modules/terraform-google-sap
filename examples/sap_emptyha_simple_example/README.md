# SAP HANA Empty HA Simple Example
...
| primary\_instance\_name | A unique name for the resource, required by GCE. Changing this forces a new resource to be created. | string | `"sap-hana-emptyha-terra-1"` | no |
...
| secondary\_instance\_name | A unique name for the resource, required by GCE. Changing this forces a new resource to be created. | string | `"sap-hana-emptyha-terra-2"` | no |
