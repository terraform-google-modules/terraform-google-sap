# SAP HANA HA SVPC Simple Example

This example illustrates how to use the `SAP HANA HA SVPC` submodule to deploy SAP HANA on GCP.

## Requirements
Make sure you go through this [Requirements section](../../modules/sap_hana_ha_svpc/README.md#requirements) for the SAP HANA HA Submodule.
