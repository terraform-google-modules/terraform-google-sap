# SAP ASE SVPC Simple Example

This example illustrates how to use the `SAP ASE SVPC` submodule to deploy SAP HANA on GCP.

## Requirements
Make sure you go through this [Requirements section](../../modules/sap_ase/README.md#requirements) for the SAP ASE SVPC Submodule.
