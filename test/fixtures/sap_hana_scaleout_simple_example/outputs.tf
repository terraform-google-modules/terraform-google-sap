...
output "instance_master_name" {
  ...
  value       = "${module.example.instance_master_name}"
}

output "instance_worker_first_node_name" {
  description = "Name of the first worker node instance"
  value       = "${module.example.instance_worker_first_node_name}"
}

output "instance_worker_second_node_name" {
  description = "Name of the second worker node instance"
  value       = "${module.example.instance_worker_second_node_name}"
}
