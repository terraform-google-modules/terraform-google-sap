...
data "template_file" "startup_sap_emptyha_hana_1" {
  template = "${file("${path.module}/files/sap_hana_emptyha.sh")}"
}

data "template_file" "startup_sap_emptyha_hana_2" {
  template = "${file("${path.module}/files/sap_hana_emptyha_secondary.sh")}"
}
...
module "example" {
  source                     = "../../../examples/sap_hana_emptyha_simple_example"
  ...
  startup_script_1           = "${data.template_file.startup_sap_emptyha_hana_1.rendered}"
  startup_script_2           = "${data.template_file.startup_sap_emptyha_hana_2.rendered}"
