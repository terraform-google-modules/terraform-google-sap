...
# SAP HANA SVPC VPC Submodule

This module handles opinionated SAP HANA Shared VPC configuration and deployment.

## Usage

The resources/services/activations/deletions that this module will create/trigger are:

- Create a Compute Instance that will host SAP HANA Shared VPC
