...
| primary\_startup\_url | DO NOT USE | `string` | `"curl -s BUILD.TERRA_SH_URL/sap_nw_ha/nw_ha_startup_scs.sh | bash -s BUILD.TERRA_SH_URL"` | no |
...
| secondary\_startup\_url | DO NOT USE | `string` | `"curl -s BUILD.TERRA_SH_URL/sap_nw_ha/nw_ha_startup_ers.sh | bash -s BUILD.TERRA_SH_URL"` | no |
