...
#
module "sap_ase" {
  source = "https://storage.googleapis.com/cloudsapdeploy/terraform/DATETIME_OF_BUILD_LATEST/terraform/sap_ase/sap_ase_module.zip"
  #
  # By default, this source file uses the latest release of the terraform module
  # for SAP on Google Cloud.  To fix your deployments to a specific release
  # of the module, comment out the source property above and uncomment the source property below.
  #
  # source = "https://storage.googleapis.com/cloudsapdeploy/terraform/DATETIME_OF_BUILD/terraform/sap_ase/sap_ase_module.zip"
  #
