...
# SAP DB2 SVPC Submodule

This module handles opinionated SAP DB2 SVPC configuration and deployment.

## Usage

The resources/services/activations/deletions that this module will create/trigger are:

- Create a Compute Instance that whill host SAP DB2 SVPC
...
module "gcp_sap_db2_svpc" {
  source                 = "../../modules/sap_db2_svpc"
