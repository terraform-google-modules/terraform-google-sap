...
| primary\_startup\_url | Startup script to be executed when the VM boots, should not be overridden. | `string` | `"curl -s BUILD.TERRA_SH_URL/sap_nw/nw_startup.sh | bash -s BUILD.TERRA_SH_URL"` | no |
