...
variable "primary_startup_url" {
  ...
  default = "curl -s https://www.googleapis.com/storage/v1/core-connect-dm-templates/202209271313/terraform/sap_hana_scaleout/startup.sh | bash -s https://www.googleapis.com/storage/v1/core-connect-dm-templates/202209271313/terraform"
}

variable "secondary_startup_url" {
  type = string
  default = "curl -s https://www.googleapis.com/storage/v1/core-connect-dm-templates/202209271313/terraform/sap_hana_scaleout/startup_secondary.sh | bash -s https://www.googleapis.com/storage/v1/core-connect-dm-templates/202209271313/terraform"
